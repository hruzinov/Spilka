...
struct TestData {
    ...
    static let testChat: Chat = .init(id: "", user: testAccount, messagesDictionary: generateMessagesDictionary())

    private static func generateMessagesDictionary() -> [String: Message] {
